"""Detect Spring Boot / Spring MVC patterns in Java source files."""
...
class SpringDetector(Detector):
    ...
    def detect(self, root: Path, files: list[FileInfo]) -> list[IPCMechanism]:
        ...
        has_boot = any("Spring Boot" in e for e in evidence)
        ...
        return [
            IPCMechanism(
                ...
                evidence=evidence,
                details={"protocol": "http", "port": port, "framework": "spring-boot"},
            )
        ]
