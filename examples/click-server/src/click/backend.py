...
class Backend:
    """Communicates with click via command-line interface."""

    def __init__(self) -> None:
        self.codebase_path = Path("/tmp/click")
        self.entry_command = "python src/click/shell_completion.py"
